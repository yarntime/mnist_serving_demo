...
public final class GraphExplorer {
  ...
  public  static final class Node extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              nodeAttr = input.readMessage(
                  NodeAttrDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
              nodeAttr_.getMutableMap().put(nodeAttr.getKey(), nodeAttr.getValue());
              break;
            }
            case 26: {
              ...
              com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
              metanodeAttr = input.readMessage(
                  MetanodeAttrDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
              metanodeAttr_.getMutableMap().put(metanodeAttr.getKey(), metanodeAttr.getValue());
              break;
            }
          }
        }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
        ...
        com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
        nodeAttr = NodeAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            .setKey(entry.getKey())
            .setValue(entry.getValue())
            .build();
        output.writeMessage(2, nodeAttr);
      }
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
           : internalGetMetanodeAttr().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
        metanodeAttr = MetanodeAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            .setKey(entry.getKey())
            .setValue(entry.getValue())
            .build();
        output.writeMessage(3, metanodeAttr);
      }
    }
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
        ...
        metanodeAttr = MetanodeAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .build();
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(3, metanodeAttr);
      }
      memoizedSize = size;
      return size;
    }
  ...
  checkByteStringIsUtf8(value);
      ...
      public Builder putNodeAttr(
        ...
        getMutableNodeAttr().put(key, value);
        return this;
      }
      /**
       * <pre>
      ...
      public Builder putAllNodeAttr(
        ...
        getMutableNodeAttr().putAll(values);
        return this;
      }
      ...
      public Builder removeMetanodeAttr(
          java.lang.String key) {
        if (key == null) { throw new java.lang.NullPointerException(); }
        getMutableMetanodeAttr().remove(key);
        return this;
      }
      /**
       * Use alternate mutation accessors instead.
      ...
      public Builder putMetanodeAttr(
        ...
        if (key == null) { throw new java.lang.NullPointerException(); }
        if (value == null) { throw new java.lang.NullPointerException(); }
        getMutableMetanodeAttr().put(key, value);
        return this;
      }
      /**
       * <pre>
      ...
      public Builder putAllMetanodeAttr(
          java.util.Map<java.lang.String, java.lang.String> values) {
        getMutableMetanodeAttr().putAll(values);
        return this;
      }
  ...
  public  static final class Edge extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              ...
              com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
              edgeAttr = input.readMessage(
                  EdgeAttrDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
              edgeAttr_.getMutableMap().put(edgeAttr.getKey(), edgeAttr.getValue());
              break;
            }
          }
        }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
        ...
        com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
        edgeAttr = EdgeAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            .setKey(entry.getKey())
            .setValue(entry.getValue())
            .build();
        output.writeMessage(3, edgeAttr);
      }
    }
  ...
  checkByteStringIsUtf8(value);
      ...
      public Builder putEdgeAttr(
        ...
        if (key == null) { throw new java.lang.NullPointerException(); }
        if (value == null) { throw new java.lang.NullPointerException(); }
        getMutableEdgeAttr().put(key, value);
        return this;
      }
      /**
       * <pre>
      ...
      public Builder putAllEdgeAttr(
          java.util.Map<java.lang.String, java.lang.String> values) {
        getMutableEdgeAttr().putAll(values);
        return this;
      }
      public final Builder setUnknownFields(
          final com.google.protobuf.UnknownFieldSet unknownFields) {
  ...
  public  static final class Graph extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50: {
              ...
              com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
              graphAttr = input.readMessage(
                  GraphAttrDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
              graphAttr_.getMutableMap().put(graphAttr.getKey(), graphAttr.getValue());
              break;
            }
          }
        }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
        ...
        nodeAttr = NodeAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .setValue(entry.getValue())
            .build();
        output.writeMessage(3, nodeAttr);
      }
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
           : internalGetMetanodeAttr().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
        metanodeAttr = MetanodeAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .setValue(entry.getValue())
            .build();
        output.writeMessage(4, metanodeAttr);
      }
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
           : internalGetEdgeAttr().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
        edgeAttr = EdgeAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .setValue(entry.getValue())
            .build();
        output.writeMessage(5, edgeAttr);
      }
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
           : internalGetGraphAttr().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
        graphAttr = GraphAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            .setKey(entry.getKey())
            .setValue(entry.getValue())
            .build();
        output.writeMessage(6, graphAttr);
      }
    }
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
        ...
        metanodeAttr = MetanodeAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .build();
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(4, metanodeAttr);
      }
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
           : internalGetEdgeAttr().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
        ...
        graphAttr = GraphAttrDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .build();
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(6, graphAttr);
      }
      memoizedSize = size;
      return size;
    }
    ...
    public static final class Builder extends
      ...
      public Builder removeGraphAttr(
          java.lang.String key) {
        if (key == null) { throw new java.lang.NullPointerException(); }
        getMutableGraphAttr().remove(key);
        return this;
      }
      /**
       * Use alternate mutation accessors instead.
      ...
      public Builder putGraphAttr(
        ...
        if (key == null) { throw new java.lang.NullPointerException(); }
        if (value == null) { throw new java.lang.NullPointerException(); }
        getMutableGraphAttr().put(key, value);
        return this;
      }
      /**
       * <pre>
      ...
      public Builder putAllGraphAttr(
          java.util.Map<java.lang.String, java.lang.String> values) {
        getMutableGraphAttr().putAll(values);
        return this;
      }
      public final Builder setUnknownFields(
          final com.google.protobuf.UnknownFieldSet unknownFields) {
