...
public class EventListenerGrpc {
  ...
  public static final io.grpc.MethodDescriptor<org.tensorflow.util.Event,
      tensorflow.DebugService.EventReply> METHOD_SEND_EVENTS =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "tensorflow.EventListener", "SendEvents"),
          io.grpc.protobuf.ProtoUtils.marshaller(org.tensorflow.util.Event.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(tensorflow.DebugService.EventReply.getDefaultInstance()));
  ...
  public static abstract class EventListenerImplBase implements io.grpc.BindableService {
    ...
    public io.grpc.stub.StreamObserver<org.tensorflow.util.Event> sendEvents(
      ...
      return asyncUnimplementedStreamingCall(METHOD_SEND_EVENTS, responseObserver);
    }
  ...
  public static final class EventListenerStub extends io.grpc.stub.AbstractStub<EventListenerStub> {
    ...
    public io.grpc.stub.StreamObserver<org.tensorflow.util.Event> sendEvents(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(METHOD_SEND_EVENTS, getCallOptions()), responseObserver);
    }
  }
  ...
  private static class MethodHandlers<Req, Resp> implements
    ...
    public MethodHandlers(EventListenerImplBase serviceImpl, int methodId) {
